<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-12">
            ...
            @forelse($candidates as $position => $positionCandidates)
                <div class="space-y-6">
            ...
            @empty
                <div class="bg-white rounded-[2.5rem] p-16 text-center border border-emerald-100 shadow-xl shadow-emerald-900/5">
                    <div class="w-20 h-20 bg-emerald-50 rounded-full flex items-center justify-center mx-auto mb-6 text-emerald-900">
                        <svg class="w-10 h-10" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"></path></svg>
                    </div>
                    <h3 class="text-2xl font-bold text-emerald-950 font-outfit mb-2">Waiting for Candidates</h3>
                    <p class="text-emerald-700/60 max-w-md mx-auto">The election is live, but no candidates have been approved by the administration yet. Please check back shortly.</p>
                </div>
            @endforelse
